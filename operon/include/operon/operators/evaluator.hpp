...
// this function allows to count the number of undefined values in the training set

class UndefinedCountEvaluator : public UserDefinedEvaluator {
public:
    explicit UndefinedCountEvaluator(Operon::Problem& problem)
        : UserDefinedEvaluator(problem, [&problem](Operon::RandomGenerator& /*unused*/, Operon::Individual& ind) {
            ...
            return EvaluatorBase::ReturnType { static_cast<Operon::Scalar>(undefinedCount) };  
        })
    {}
};
